...
def calculate_Kats_stuff_plus_for_pitch_type(df, pitch_type, player_fastball_velocity=None):
    """Calculate Kats Stuff+ for a specific pitch type using updated weights"""
...
def create_stuff_plus_radar_chart(pitch_stuff, player_name):
    ...
    ax.fill(angles, stuff_values, alpha=0.3, color="#e4180a")
...
def create_stuff_plus_bar_chart(pitch_stuff, player_name):
    ...
    bars = ax.bar(pitch_types, stuff_values, color="#df0b0b", alpha=0.8, edgecolor='white')
...
def display_player_assessment_data(player_name):
    ...
    if not os.path.exists(excel_file_path):
        st.error("Assessment table file not found at data/KatsBaseballTableAssessment.xlsx")
        return
        ...
        for pitch_type in valid_pitch_types:
            ...
            if len(pitch_subset) > 0:
                ...
                if stuff_plus_val is None and len(velocity_clean) > 0:
                    ...
                    try:
                        stuff_plus_val = calculate_Kats_stuff_plus_for_pitch_type(
